...
def generate_launch_description():
    ...
    enable_routing_arg = DeclareLaunchArgument("enable_routing", default_value="false", description="Enable route generation")
    ...
    return LaunchDescription([
        ...
        pub_rate_arg, init_x_arg, init_y_arg, init_yaw_arg,
        simulation_node, visualization_node, visualize_map_launch, routing_launch, rviz_node, rqt_gui_node
    ])
